...
use App\Http\Controllers\Settings\PaymentDetailsController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('settings/payment-details', [PaymentDetailsController::class, 'update'])->name('payment-details.update');
