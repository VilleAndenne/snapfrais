                            ...
                            <tr v-for="sheet in filteredExpenseSheets" :key="sheet.id"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <Link :href="'/expense-sheet/' + sheet.id"
                                          class="inline-flex items-center rounded-md bg-primary px-3 py-1.5 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
                    ...
                    <div v-if="filteredExpenseToValidate.length > 0" class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-secondary/20">
                            ...
                            <tr v-for="sheet in filteredExpenseToValidate" :key="sheet.id"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-foreground">{{ sheet.user?.name || 'Utilisateur inconnu'
                                        }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <div class="flex justify-end gap-2">
                                        <Button @click="approveExpenseSheet(sheet.id)"
                                                class="inline-flex items-center rounded-md bg-secondary px-3 py-1.5 text-sm font-medium text-secondary-foreground shadow-sm hover:bg-secondary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary">
                                            <CheckCircle class="mr-1.5 h-4 w-4" />
                                            Valider
                                        </Button>
                                        <Link :href="'/expense-sheet/' + sheet.id"
                                              class="inline-flex items-center rounded-md bg-accent px-3 py-1.5 text-sm font-medium text-accent-foreground shadow-sm hover:bg-accent/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">
                                            <Eye class="mr-1.5 h-4 w-4" />
                                            Voir
                                        </Link>
                                    </div>
