                            ...
                            <div v-for="(cost, costIndex) in form.costs" :key="costIndex"
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <Button type="button" variant="outline" size="sm"
                                                @click="addRequirement(costIndex)">
                                            <PlusIcon class="h-4 w-4 mr-1" />
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            ...
                                            <Select v-model="requirement.type">
                                                <SelectTrigger
                                                    ...
                                                    :class="{ 'border-destructive': form.errors[`costs.${costIndex}.requirements.${requirementIndex}.type`] }">
                                                    <SelectValue placeholder="Sélectionner un type" />
                                                </SelectTrigger>
                                                <SelectContent>
                                            ...
                                            <p v-if="form.errors[`costs.${costIndex}.requirements.${requirementIndex}.type`]"
                                               class="text-sm text-destructive">
                                                {{
